...
const About = () => {
  return (
    <div className="text-gray-900 max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="bg-white shadow-lg p-8 border border-gray-200 rounded-lg mb-12 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white shadow-lg p-8 border border-gray-200 rounded-lg flex flex-col items-center">
